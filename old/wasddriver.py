...
pwm0 = PWM(Pin(12), freq=FREQ)  # motor A input 1
pwm1 = PWM(Pin(13), freq=FREQ)  # motor A input 2
pwm2 = PWM(Pin(26), freq=FREQ)  # motor B input 1
pwm3 = PWM(Pin(25), freq=FREQ)  # motor B input 2
